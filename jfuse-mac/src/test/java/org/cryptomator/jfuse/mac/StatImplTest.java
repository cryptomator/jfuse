...
public class StatImplTest {
	...
	public static Stream<Arguments> testGetters() {
		return Stream.of(
				Arguments.arguments((SetInMemorySegment<Short>) stat::st_mode$set, Named.of("getMode()", (GetInStat<Integer>) Stat::getMode), (short) 42),
				...
				Arguments.arguments((SetInMemorySegment<Short>) stat::st_nlink$set, Named.of("getNLink()", (GetInStat<Long>) Stat::getNLink), (short) 42),
	...
	public static Stream<Arguments> testSetters() {
		return Stream.of(
				Arguments.arguments(Named.of("setMode()", (SetInStat<Integer>) Stat::setMode), (GetInMemorySegment<Short>) stat::st_mode$get, 42),
				...
				Arguments.arguments(Named.of("setNLink()", (SetInStat<Short>) Stat::setNLink), (GetInMemorySegment<Short>) stat::st_nlink$get, (short) 42),
