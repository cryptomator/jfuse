 ...
 *     int (*getattr)(const char *, struct fuse_stat *, struct fuse3_file_info *);
 ...
 *     int (*chmod)(const char *, fuse_mode_t, struct fuse3_file_info *);
 *     int (*chown)(const char *, fuse_uid_t, fuse_gid_t, struct fuse3_file_info *);
 *     int (*truncate)(const char *, fuse_off_t, struct fuse3_file_info *);
 *     int (*open)(const char *, struct fuse3_file_info *);
 *     int (*read)(const char *, char *, size_t, fuse_off_t, struct fuse3_file_info *);
 *     int (*write)(const char *, const char *, size_t, fuse_off_t, struct fuse3_file_info *);
 *     int (*statfs)(const char *, struct fuse_statvfs *);
 *     int (*flush)(const char *, struct fuse3_file_info *);
 *     int (*release)(const char *, struct fuse3_file_info *);
 *     int (*fsync)(const char *, int, struct fuse3_file_info *);
 *     int (*setxattr)(const char *, const char *, const char *, size_t, int);
 *     int (*getxattr)(const char *, const char *, char *, size_t);
 *     int (*listxattr)(const char *, char *, size_t);
 *     int (*removexattr)(const char *, const char *);
 *     int (*opendir)(const char *, struct fuse3_file_info *);
 *     int (*readdir)(const char *, void *, fuse3_fill_dir_t, fuse_off_t, struct fuse3_file_info *, enum fuse3_readdir_flags);
 *     int (*releasedir)(const char *, struct fuse3_file_info *);
 *     int (*fsyncdir)(const char *, int, struct fuse3_file_info *);
 *     void *(*init)(struct fuse3_conn_info *, struct fuse3_config *);
 *     void (*destroy)(void *);
 *     int (*access)(const char *, int);
 *     int (*create)(const char *, fuse_mode_t, struct fuse3_file_info *);
 *     int (*lock)(const char *, struct fuse3_file_info *, int, struct fuse_flock *);
 *     int (*utimens)(const char *, const struct fuse_timespec *, struct fuse3_file_info *);
 *     int (*bmap)(const char *, size_t, uint64_t *);
 *     int (*ioctl)(const char *, int, void *, struct fuse3_file_info *, unsigned int, void *);
 *     int (*poll)(const char *, struct fuse3_file_info *, struct fuse3_pollhandle *, unsigned int *);
 *     int (*write_buf)(const char *, struct fuse3_bufvec *, fuse_off_t, struct fuse3_file_info *);
 *     int (*read_buf)(const char *, struct fuse3_bufvec **, size_t, fuse_off_t, struct fuse3_file_info *);
 *     int (*flock)(const char *, struct fuse3_file_info *, int);
 *     int (*fallocate)(const char *, int, fuse_off_t, fuse_off_t, struct fuse3_file_info *);
 * }
 * }
 */
